# Windsurf Configuration for Claude

## Development Rules Migrated from Cursor/Claude
...
- VueJS/NuxtJS as primary development framework
- Composition API patterns for Vue.js implementation
- Strict TypeScript for type safety
- TailwindCSS for all styling needs
- shadcn/ui component patterns when relevant

### Build & Package Management
- Bun exclusive for frontend build processes
- All package operations via bun/bunx
- No npm/npx/yarn/deno usage
- Bun documentation and best practices compliance
